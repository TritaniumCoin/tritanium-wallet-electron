...
class WalletShellApi {
    constructor(args) {
        ...
        this.tx_fee = (args.tx_fee !== undefined) ? args.tx_fee : 0.0001;
        this.anonimity = 3;
    }
    ...
    sendTransaction(params) {
        return new Promise((resolve, reject) => {
            ...
            if (parseFloat(params.fee) < 0.0001) return reject(new Error('Minimum fee is 0.0001 TTNZ'));
            //[{address: "TRI1xxxx...", amount: 100}];
            var req_params = {
